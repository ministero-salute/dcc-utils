...
const keys = require('./data/It_Test_Signing_Keys.json');

const main = async function () {
  // example qr from italian test data  (https://github.com/eu-digital-green-certificates/dgc-testdata/tree/main/IT)
  ...
  // use testkeys.json to validate italian test data
  const certificate = await dcc.checkSignatureWithKeysList(keys);
  if (!certificate) {
    console.log('Invalid pass!');
  } else {
    console.log('Signed with', certificate);
